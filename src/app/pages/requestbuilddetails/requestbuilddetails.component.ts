...
@Component({
  selector: 'app-requestbuilddetails',
  templateUrl: './requestbuilddetails.component.html',
  styleUrls: ['./requestbuilddetails.component.scss'],
})
export class RequestbuilddetailsComponent  implements OnInit {
